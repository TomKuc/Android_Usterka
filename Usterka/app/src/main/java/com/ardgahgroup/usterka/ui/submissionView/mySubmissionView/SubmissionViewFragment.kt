package com.ardgahgroup.usterka.ui.submissionView.mySubmissionView
...
import com.ardgahgroup.usterka.databinding.FragmentSubmissionViewBinding
...
class SubmissionViewFragment : Fragment() {
    ...
    private var _binding: FragmentSubmissionViewBinding? = null
    private lateinit var viewModel: SubmissionViewViewModel
    private lateinit var mainActivity: UserMenuActivity
    private val binding get() = _binding!!
    private val args: SubmissionViewFragmentArgs by navArgs()

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        viewModel = ViewModelProvider(this)[SubmissionViewViewModel::class.java]
        _binding = FragmentSubmissionViewBinding.inflate(inflater, container, false)
